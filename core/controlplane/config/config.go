...
func NewDefaultCluster() *Cluster {
	...
	return &Cluster{
		DeploymentSettings: DeploymentSettings{
			...
			CalicoCtlImage:                     model.Image{Repo: "gcr.io/kube-aws/ctl", Tag: "v1.6.3", RktPullDocker: false},
			...
			Kube2IAMImage:                      model.Image{Repo: "gcr.io/kube-aws/kube2iam", Tag: "0.9.0", RktPullDocker: false},
			...
			FlannelImage:                       model.Image{Repo: "gcr.io/kube-aws/flannel", Tag: "v0.9.1", RktPullDocker: true},
			JournaldCloudWatchLogsImage:        model.Image{Repo: "gcr.io/kube-aws/journald-cloudwatch-logs", Tag: "0.1", RktPullDocker: true},
		},
